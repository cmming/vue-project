                        ...
                        <form class="form-horizontal no-margin" @submit.prevent="validateBeforeSubmit">
                            <div class="form-group">
                                ...
                                <div :class="{'col-lg-6': true, 'has-error': errors.has('email') }">
                                    ...
                                    <!--错误提示信息-->
                                    <span v-show="errors.has('email')" class="err_msg">
                                        <!--不同类型的错误-->
                                        <span v-show="errors.has('email:required')">邮箱不能为空</span>
                                        <span v-show="errors.has('email:email')">邮箱格式错误</span>
                                    </span>
                                </div>
                            </div>
                            <!-- /form-group -->
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <span v-show="errors.has('inlineRadio')" class="err_msg">
                                        <!--不同类型的错误-->
                                        <span v-show="errors.has('inlineRadio')">必选  </span>
                                    </span>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="checkbox inline-block">
                                     ...
                                     <span v-show="errors.has('inlineCheckbox')" class="err_msg">
                                        <!--不同类型的错误-->
                                        <span v-show="errors.has('inlineCheckbox')">必选</span>
                                    </span>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div :class="{'col-lg-6': true, 'has-error': (errors.has('userTel:required')|errors.has('userTel:regex'))}">
                                    ...
                                    <span v-show="errors.has('userTel')" class="err_msg">
                                        <!--不同类型的错误-->
                                        <span v-show="errors.has('userTel:required')">手机号不能为空</span>
                                        <span v-show="errors.has('userTel:regex')">手机号格式错误</span>
                                    </span>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <span v-show="errors.has('minVal')" class="err_msg">
                                        <!--不同类型的错误-->
                                        <span v-show="errors.has('minVal:required')">不能为空 </span>
                                        <span v-show="errors.has('minVal:min_value')">最小值为6 </span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="password" name="userPwd" v-model="userPwd" placeholder="Password" v-validate="'confirmed:confirmPwd'" id="textbox1" class="form-control input-sm m-bottom-md">
                                    <input type="password" name="confirmPwd" v-model="confirmPwd" placeholder="Confirm Password" class="form-control input-sm">
                                    <!--错误提示信息-->
                                    <span v-show="errors.has('userPwd')" class="err_msg">
                                        <!--不同类型的错误-->
                                        <span v-show="errors.has('userPwd:confirmed')">两次密码必须一致 </span>
                                    </span>
                                </div>
                                <!-- /.col -->
                            </div>
